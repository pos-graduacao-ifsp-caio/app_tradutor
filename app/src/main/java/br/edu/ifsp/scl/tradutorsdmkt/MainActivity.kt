...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        idiomaOrigemSp.adapter = ArrayAdapter(this,android.R.layout.simple_spinner_item,idiomas)
        idiomaOrigemSp.setSelection(0) //pt

        // Cria e seta um Adapter com os idiomas de origem para um Spinner
        idiomaDestinoSp.adapter = ArrayAdapter(this,android.R.layout.simple_spinner_item,idiomas)
